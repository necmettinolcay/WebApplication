    ...
    <div id="content">
      ...
      <div class="products">
        ...
        <ul>
          ...
          <li> <a href="ProductServlet?mydata1=${wishlis1.path[0]}&mydata2=${wishlist1.price[0]}"><img src="${wishlist1.path[0]}" alt="" /></a>
            <div class="product-info">
              <h3>${wishlist1.name[0]}</h3>
              <div class="product-desc">
                <h4>${wishlis1.description[0] }</h4>
                <p>${wishlist1.description[0] }<br />
                  </p>
                <strong class="price">$${wishlist1.price[0]}</strong> </div>
            </div>
          </li>
          <li> <a href="ProductServlet?mydata1=${wishlist.path[1]}&mydata2=${wishlist1.price[1]}"><img src="${wishlist1.path[1]}" alt="" /></a>
            <div class="product-info">
              <h3>${wishlist1.name[1] }</h3>
              <div class="product-desc">
                <h4>${wishlist1.description[1] }</h4>
                <p>${wishlist1.description[1] }<br />
                  </p>
                <strong class="price">$${wishlist1.price[1]}</strong> </div>
            </div>
          </li>
          <li class="last"> <a href="ProductServlet?mydata1=${wishlist1.path[2]}&mydata2=${wishlist1.price[2]}"><img src="${wishlist1.path[2]}" alt="" /></a>
            <div class="product-info">
              <h3>${wishlist1.name[2] }</h3>
              <div class="product-desc">
                <h4>${wishlist1.description[2] }</h4>
                <p>${wishlist1.description[2] }<br />
                  </p>
                <strong class="price">$${wishlist1.price[2]}</strong> </div>
            </div>
          </li>
        </ul>
	<ul>
          <li> <a href="ProductServlet?mydata1=${wishlist1.path[3]}&mydata2=${wishlist1.price[3]}"><img src="${wishlist1.path[3]}" alt="" /></a>
            <div class="product-info">
              <h3>${wishlist1.name[3] }</h3>
              <div class="product-desc">
                <h4>${wishlist1.description[3] }</h4>
                <p>${wishlist1.description[3] }<br />
                  </p>
                <strong class="price">$${wishlist1.price[3]}</strong> </div>
            </div>
          </li>
